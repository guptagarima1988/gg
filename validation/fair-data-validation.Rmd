...
```{r}
# need to refactor this - apply unique key test to extractions
nrow(read_csv(here(pipeline_path, "staging_top_3_arunachal.csv")))
...
nrow(read_csv(here(pipeline_path, "staging_top_3_tehri.csv")))
